...
function Post() {
    ...
    return (
        <div className="postpage">
            ...
            <div className="postContent" style={postDivStyle}>
                <ul>
                    <li>
                        ...
                        <span style={postInfoStyle} className="post-regist-time">
                            5분 전
                        </span>
                        <span style={postInfoStyle} className="post-user-nickname">
                            manager
                        </span>
...
const postDivStyle = {
    height:'90px',
    width:'100%',
    borderBottom:"1.5px solid #B2B2B2BF",
    marginTop:'-10px',
    // listStyle: 'none',
}
...
const writeStyle = {
    ...
    // marginBottom: "500px",
    left: "150px",
    border: "3px solid rgba(255,225,117,0.75)",
    borderRadius: "30px",
    width: "90px",
    height: "30px",
    textAlign: "center",
